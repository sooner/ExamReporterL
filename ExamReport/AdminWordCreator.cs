...
namespace ExamReport
{
    class AdminWordCreator
    {
        ...
        public void creating_word(Admin_WordData w_data, Admin_WordData l_data)
        {
            ...
            insertQXtable("    文综学科得分率表", w_data.districts.Rows[14], w_data.districts.Rows[15]);
            ...
            insertQXchart("    数学（理）学科得分率图", l_data.districts.Rows[5]);
            oDoc.Characters.Last.InsertBreak(oPagebreak);
            insertText(ExamTitle2, "英语"); 
            ...
            insertQXtable("    理综学科得分率表", l_data.districts.Rows[14], l_data.districts.Rows[15]);
        ...
        public void insertQXtable(string title, DataRow avg, DataRow diff)
        {
            ...
            table.Cell(1, 7).Range.Text = "海淀";
            table.Cell(1, 8).Range.Text = "朝阳";
            table.Cell(1, 9).Range.Text = "石景山";
            table.Cell(1, 10).Range.Text = "丰台";
            table.Cell(1, 11).Range.Text = "燕山";

            table.Cell(4, 1).Range.Text = "区县";
            table.Cell(4, 2).Range.Text = "通州";
            table.Cell(4, 3).Range.Text = "顺义";
            table.Cell(4, 4).Range.Text = "昌平";
            table.Cell(4, 5).Range.Text = "门头沟";
            table.Cell(4, 6).Range.Text = "房山";
